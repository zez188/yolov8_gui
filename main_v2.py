...
class DetThread(QThread):
    ...
    def __init__(self):
        ...
        self.weights = './pt/yolov8s.pt'
        self.current_weight = './pt/yolov8s.pt'
        self.source = '0'
    ...
    def run(self,
        ...
        # Load model
        # model = attempt_load_one_weight(self.weights, device=device)  # load FP32 model
        model = YOLO(self.current_weight)
        names = model.module.names if hasattr(model, 'module') else model.names  # get class names

        # Dataloader
        dataset = LoadImages(self.source, img_size=imgsz)
        # dataset = LoadImagesAndVideos(self.source, img_size=imgsz)
        # dataset = LoadImagesAndVideos(self.source)
        ...
        while True:
            ...
            if self.is_continue:
                ...
                # args = dict(model=model, source=img)
